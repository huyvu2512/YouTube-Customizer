...
// @version      1.0
// @description  Thay đổi logo YouTube tiêu chuẩn thành logo YouTube Premium
    ...
    window.addEventListener('load', () => {
        ...
        function modifyYtIcon(ytdLogos) {
            ytdLogos.forEach(ytdLogo => {
                ...
                // Thay thế nội dung SVG bằng logo Premium mới
                // Đây là phần chính chứa dữ liệu hình ảnh logo
